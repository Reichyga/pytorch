...
static struct PyGetSetDef THPGenerator_properties[] = {
  {"device", (getter)THPGenerator_get_device, 0, 0, 0},
  {0}
};

static PyMethodDef THPGenerator_methods[] = {
  {"get_state",       (PyCFunction)THPGenerator_getState,       METH_NOARGS,  0},
  {"set_state",       (PyCFunction)THPGenerator_setState,       METH_O,       0},
  {"manual_seed",     (PyCFunction)THPGenerator_manualSeed,     METH_O,       0},
  {"seed",            (PyCFunction)THPGenerator_seed,           METH_NOARGS,  0},
  {"initial_seed",    (PyCFunction)THPGenerator_initialSeed,    METH_NOARGS,  0},
  {0}
};

static struct PyMemberDef THPGenerator_members[] = {
  {(char*)"_cdata", T_ULONGLONG, offsetof(THPGenerator, cdata), READONLY, 0},
  {0}
};
