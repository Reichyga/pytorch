...
static struct PyGetSetDef THPFInfo_properties[] = {
    {"bits", (getter)THPDTypeInfo_bits, 0, 0, 0},
    {"eps", (getter)THPFInfo_eps, 0, 0, 0},
    {"max", (getter)THPFInfo_max, 0, 0, 0},
    {"min", (getter)THPFInfo_min, 0, 0, 0},
    {"tiny", (getter)THPFInfo_tiny, 0, 0, 0},
    {0}};
...
PyTypeObject THPFInfoType = {
    PyVarObject_HEAD_INIT(0, 0) "torch.finfo", /* tp_name */
...
static struct PyGetSetDef THPIInfo_properties[] = {
    {"bits", (getter)THPDTypeInfo_bits, 0, 0, 0},
    {"max", (getter)THPIInfo_max, 0, 0, 0},
    {"min", (getter)THPIInfo_min, 0, 0, 0},
    {0}};
...
PyTypeObject THPIInfoType = {
    PyVarObject_HEAD_INIT(0, 0) "torch.iinfo", /* tp_name */
