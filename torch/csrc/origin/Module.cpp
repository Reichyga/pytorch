...
THPGenerator *THPDefaultCPUGenerator = 0;
...
static PyMethodDef TorchMethods[] = {
  {"_initExtension",  (PyCFunction)THPModule_initExtension,   METH_O,       0},
  {"_autograd_init",  (PyCFunction)THPAutograd_initExtension, METH_NOARGS,  0},
  {"_add_docstr",     (PyCFunction)THPModule_addDocStr,       METH_VARARGS, 0},
  {"_init_names",     (PyCFunction)THPModule_initNames,       METH_O,       0},
  {"_has_distributed",(PyCFunction)THPModule_hasDistributed,  METH_NOARGS,  0},
  {"_safe_call",      (PyCFunction)(void(*)(void))THPModule_safeCall, METH_VARARGS | METH_KEYWORDS, 0},
  {"_set_default_tensor_type", (PyCFunction)THPModule_setDefaultTensorType, METH_O, 0},
  {"_set_default_dtype", (PyCFunction)THPModule_setDefaultDtype, METH_O, 0},
  {"_infer_size",     (PyCFunction)THPModule_inferSize,         METH_VARARGS, 0},
  {"_crash_if_csrc_asan", (PyCFunction)THPModule_crashIfCsrcASAN, METH_O, 0},
  {"_crash_if_csrc_ubsan", (PyCFunction)THPModule_crashIfCsrcUBSAN, METH_O, 0},
  {"_crash_if_aten_asan", (PyCFunction)THPModule_crashIfATenASAN, METH_O, 0},
  {"_show_config",    (PyCFunction)THPModule_showConfig, METH_NOARGS, 0},
  {"_parallel_info",    (PyCFunction)THPModule_parallelInfo, METH_NOARGS, 0},
  {"_set_backcompat_broadcast_warn", (PyCFunction)THPModule_setBackcompatBroadcastWarn, METH_O, 0},
  {"_get_backcompat_broadcast_warn", (PyCFunction)THPModule_getBackcompatBroadcastWarn, METH_NOARGS, 0},
  {"_set_backcompat_keepdim_warn", (PyCFunction)THPModule_setBackcompatKeepdimWarn, METH_O, 0},
  {"_get_backcompat_keepdim_warn", (PyCFunction)THPModule_getBackcompatKeepdimWarn, METH_NOARGS, 0},
  {"get_num_threads", (PyCFunction)THPModule_getNumThreads,     METH_NOARGS,  0},
  {"set_num_threads", (PyCFunction)THPModule_setNumThreads,     METH_O,       0},
  {"get_num_interop_threads", (PyCFunction)THPModule_getNumInteropThreads,     METH_NOARGS,  0},
  {"set_num_interop_threads", (PyCFunction)THPModule_setNumInteropThreads,     METH_O,       0},
  {"_get_cudnn_enabled", (PyCFunction)THPModule_userEnabledCuDNN, METH_NOARGS,     0},
  {"_set_cudnn_enabled", (PyCFunction)THPModule_setUserEnabledCuDNN, METH_O,  0},
  {"_get_mkldnn_enabled", (PyCFunction)THPModule_userEnabledMkldnn, METH_NOARGS,     0},
  {"_set_mkldnn_enabled", (PyCFunction)THPModule_setUserEnabledMkldnn, METH_O,  0},
  {"_get_cudnn_benchmark", (PyCFunction)THPModule_benchmarkCuDNN, METH_NOARGS,     0},
  {"_set_cudnn_benchmark", (PyCFunction)THPModule_setBenchmarkCuDNN, METH_O,  0},
  {"_get_cudnn_deterministic", (PyCFunction)THPModule_deterministicCuDNN, METH_NOARGS,     0},
  {"_set_cudnn_deterministic", (PyCFunction)THPModule_setDeterministicCuDNN, METH_O,  0},
  {"_to_dlpack",      (PyCFunction)THPModule_toDLPack,          METH_O,       0},
  {"_from_dlpack",    (PyCFunction)THPModule_fromDLPack,        METH_O,       0},
  {"set_flush_denormal", (PyCFunction)THPModule_setFlushDenormal, METH_O,     0},
  {"get_default_dtype", (PyCFunction)THPModule_getDefaultDtype, METH_NOARGS,  0},
  {"_get_default_device", (PyCFunction)THPModule_getDefaultDevice, METH_NOARGS,   0},
  {"_get_qengine", (PyCFunction)THPModule_qEngine, METH_NOARGS, 0},
  {"_set_qengine", (PyCFunction)THPModule_setQEngine, METH_O, 0},
  {"_supported_qengines", (PyCFunction)THPModule_supportedQEngines, METH_NOARGS, 0},
  {0, 0, 0, 0}
};
...
static PyMethodDef _THCUDNN_methods[] = {
  {"_cudnn_version", (PyCFunction)THCUDNN_cudnn_version, METH_VARARGS, 0},
  {0}
};
...
#define ASSERT_TRUE(cmd) if (!(cmd)) return 0
