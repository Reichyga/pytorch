...
static PyObject* wrap_tuple_fn(Args ... args)
{
  ...
  if (PyTuple_Check(result.get())) {
    return PyObject_CallFunctionObjArgs((PyObject*)&THPSizeType, result.get(), 0);
  }
...
static PyMethodDef THPSize_methods[] = {
  {"numel",       (PyCFunction)THPSize_numel,       METH_NOARGS,  0},
  {"__reduce__",  (PyCFunction)THPSize_reduce,      METH_NOARGS,  0},
  {0}
};
